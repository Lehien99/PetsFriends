                            ...
                            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="custom-file">
                                        <input type="file" class=" form-control custom-file-input" id="avatar"
                                            type="file" name="avatar">
                                        <label class="custom-file-label" for="customFile">Upload file</label>
                                    </div>
                                    {{-- <input class="form-control form-control-user" id="avatar" type="file" name="avatar"> --}}
                                </div>


                                <button type="submit" class="btn btn-user btn-block" style="color: white">
                                    {{ __('Register') }}
                                </button>
                                <!-- <hr>
